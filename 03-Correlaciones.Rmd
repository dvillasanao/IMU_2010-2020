...
p <- lapply(1:2, function(i){ 
                  x <- cor(get(paste0("tabla_",tablas[i]))[,11:21]) 
                  corrplot(x,
...
<a href="https://raw.githubusercontent.com/dvillasanao/IMU_2010-2020/main/img/correlaciones_2010_2020.png" data-lightbox="image-1" data-title="correlaciones">
